...
    <Link
      to={`/student/events/${event.id}`}
      // NOU: Aplicăm h-full pe containerul Link-ului
      className="block h-full bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden hover:border-white/20 hover:bg-white/10 transition-all group"
    >
      {/* Image */}
...
      {/* CONTENT WRAPPER: NOU - Flex Column Container */}
      <div className="p-5 flex flex-col h-full"> 
        
        {/* ZONA DE CONȚINUT VARIABILĂ: NOU - Flex Grow */}
...
            )}
        </div>
        {/* END ZONA DE CONȚINUT VARIABILĂ */}


        {/* CTA (Vezi detalii): Rămâne fixă la bază */}
