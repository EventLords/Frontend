  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden">
          ...
          <form onSubmit={handlePasswordChange} className="p-6 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-[#4ECDC4]/50 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 bg-[#4ECDC4] text-white font-semibold rounded-xl hover:bg-[#3dbdb5] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isChangingPassword ? (
                <>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden">
          <div className="px-6 py-4 border-b border-white/10 flex items-center gap-3">
            <Bell size={20} className="text-[#4ECDC4]" />
            <h2 className="text-lg font-semibold text-white">Preferințe notificări</h2>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-medium">Notificări push</p>
                  <p className="text-sm text-white/50">Primește notificări în browser</p>
                </div>
              </div>
              <Toggle 
            ...
            <div className="flex items-center gap-2 text-white/40 text-sm uppercase tracking-wider">
              <Mail size={14} />
              Email
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white font-medium">Confirmări înscriere</p>
                <p className="text-sm text-white/50">Email la înscrierea la evenimente</p>
              </div>
              <Toggle 
                enabled={notifications.emailEnrollment} 
                onChange={() => handleNotificationChange('emailEnrollment')} 
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white font-medium">Remindere</p>
                <p className="text-sm text-white/50">Email cu 24h înainte de eveniment</p>
              </div>
              <Toggle 
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white font-medium">Actualizări și noutăți</p>
                <p className="text-sm text-white/50">Newsletter și evenimente noi</p>
              </div>
              <Toggle 
        ...
        <div className="bg-red-500/10 backdrop-blur-sm rounded-2xl border border-red-500/30 overflow-hidden">
          <div className="px-6 py-4 border-b border-red-500/30 flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-red-400">Zonă periculoasă</h2>
          </div>
          ...
          <div className="relative w-full max-w-md bg-[#1a1a4e] rounded-2xl shadow-2xl p-6">
            ...
            <div className="mb-6">
              <label className="block text-sm text-white/60 mb-2">
                Scrie <span className="font-bold text-red-400">STERGE</span> pentru a confirma
              </label>
              <input
                type="text"
